...
public class InterfazTriqui extends javax.swing.JFrame implements ActionListener {
    ...
    // cuenta los tiros realizados
    int tiros_counter = 0;

    // se instancia una matriz de 3x3 botones
    JButton[][] matriz_botones = new JButton[3][3];

    // indica si es el turno del jugador X
    Boolean esTurnoJugadorX = true;

    //guarda la marca del tirador {X, O}
    String marcaTirador = "X";
    ...
    public InterfazTriqui() {
        ...
        for (int y = 0; y < 3; y++) {
            for (int x = 0; x < 3; x++) {
                ...
                matriz_botones[x][y].setText(x + "" + y);
    ...
    private void comprobarTiro() {
        // hace comprobacion despues de 6 tiros antes es imposible ganar
        if (tiros_counter++ >= 6) {
        ...
        if (tiros_counter == 9) {
            JOptionPane.showMessageDialog(this, "Reiniciando el juego");
            reiniciar();
        }
